    ...
    <div class="gvb_setting_body">
      ...
      >
        ...
        <a-form-item label="存储桶" name="bucket" has-feedback
                     :rules="[{ required: true, message: '请输入bucket' ,trigger: 'blur'}]">
          <a-input v-model:value="state.bucket" placeholder="bucket"/>
        </a-form-item>
        <a-form-item label="访问链接" name="cdn" has-feedback
                     :rules="[{ required: true, message: '请输入bucket' ,trigger: 'blur'}]">
          <a-input v-model:value="state.cdn" placeholder="bucket"/>
        </a-form-item>
